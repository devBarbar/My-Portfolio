  ...
  topFeatures: [
    {
      ...
      description:
        "Skilled at identifying issues and implementing effective solutions. I take pride in my ability to unravel complex technical problems and drive projects to successful completion.",
      icon: <Magic fill="#FF4ECD" />,
    },
    {
      title: "Bridging Frontend and Backend",
      description:
        "Fluent in both frontend and backend languages. My comprehensive knowledge ensures seamless integration and consistency across the web development spectrum.",
      icon: <Flash fill="#FF4ECD" />,
    },
    {
      title: "Aesthetic Intuition",
      description:
        "I build visually compelling websites that offer excellent user experience. Attention to detail and understanding design principles are part of my toolkit..",
      icon: <Moon fill="#FF4ECD" />,
    },
    {
      title: "Time Management",
      description:
        "With a knack for setting priorities and managing tasks, I meet deadlines while maintaining high coding standards. I understand that time is as important as quality.        .",
