...
import {Grid, Row, Col, Link, Text, Collapse, Spacer} from "@nextui-org/react";
...
const BuiltInStitchesSection = () => {
  ...
  const handleChange = (value: number | undefined) => {
    value && setActiveItem(items[value - 1]);
  };
    ...
    <InView as="section" className="inview-section" onChange={setIsVisible}>
      ...
      <Section css={{position: "relative"}}>
        ...
        <Subtitle>
          ...
          &nbsp;utilities for speeding up your workflow by abbreviating CSS properties, grouping
          multiple CSS properties together, or simplifying a tricky syntax.
        </Subtitle>
